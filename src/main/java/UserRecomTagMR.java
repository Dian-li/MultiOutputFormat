 ...
 *       科技中心推送的用户推荐标签数据解析.
 */
public class UserRecomTagMR extends Configured implements Tool {
    private static Logger LOG = Logger.getLogger(UserRecomTagMR.class);
    ...
    public static String REC_USR_TAG_IN = "D:/bigdata/data";
    public static String REC_USR_TAG_OUT = "D:/bigdata/output";
    ...
    public static class UserRecomTagMapper extends Mapper<LongWritable, Text, NullWritable, OrcStruct> {
        ...
        private MultipleOutputs<NullWritable,OrcStruct> mos = null;
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                if(this.device_uuid.getLength() != 0 ){
                    mos.write(hive_k,orcStruct,"device");
                }else if(this.passport.getLength() != 0){
                    mos.write(hive_k,orcStruct,"password");
                }else{
                    mos.write(hive_k,orcStruct,"error");
                }
    ...
    public int run(String[] args) throws Exception {
        ...
        if (args.length == 1 && (args[0].length() == 8 || args[0].length() == 10)) {
            ...
            try {
                job.setJarByClass(UserRecomTagMR.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        ToolRunner.run(new UserRecomTagMR(), args);
    }
}
